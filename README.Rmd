...
| 2018-10-30 | Import affordable housing data (csv downladed from Chicago Data Portal), do some basic data manipulation with `dplyr`, make a map with `leaflet` | [2018-10-30_housing.R](https://github.com/angela-li/r-learning-group/blob/master/R/2018-10-30_housing.R) |
